            ...
            <div className="space-y-6 text-center md:text-left">
              ...
              <div className="space-y-4 text-lg md:text-xl">
                ...
                <Select value={selectedState} onValueChange={setSelectedState}>
                  <SelectTrigger 
                    id="state-selector"
                    className="w-full max-w-md rounded-lg border-2 border-white/20 bg-white/10 px-4 py-3 text-white backdrop-blur-sm focus:border-white focus:ring-white data-[placeholder]:text-white/70"
                  >
      ...
      <footer role="contentinfo" className="border-t bg-slate-800 text-white">
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="mt-8 text-center text-sm text-slate-400">
            <p>200 West Jackson Blvd, Suite 1400, Chicago, IL 60606, United States</p>
